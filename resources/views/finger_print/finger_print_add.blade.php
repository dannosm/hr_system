                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card chd">
                           <div class="card-header d-flex">
                                        <h4 class="card-header-title language">ADD FINGER PRINT</h4>
                                ...
                                @csrf
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9 col-lg-10">
                                                <input type="text" class="form-control enter_tab input_validasi " data-nextTab='1'  placeholder="Mesin Name" name="name">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputEmail2" class="col-3 col-lg-2 col-form-label text-right language">Ip</label>
                                            <div class="col-9 col-lg-10">
                                                <input type="text" class="form-control enter_tab input_validasi " data-nextTab='2'  placeholder="Ip " name="ip">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputEmail2" class="col-3 col-lg-2 col-form-label text-right language">Port</label>
                                            <div class="col-9 col-lg-10">
                                                <input type="text" class="form-control enter_tab input_validasi " data-nextTab='3'  placeholder="Port" name="port">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputEmail2" class="col-3 col-lg-2 col-form-label text-right language">Type</label>
                                            <div class="col-9 col-lg-10">
                                                <select class="form-control form-control-sm enter_tab" data-nextTab='4' placeholder="status" name="type"/>
                                                    <option value="" class="language">Choose</option>
                                                    <option value="attendance" class="language">Attendance</option>
                                                    <option value="break" class="language">Break</option>
                                                </select>
                                            </div>
                                        </div>
                                         <div class="form-group row">
                                            ...
                                            <div class="col-9 col-lg-10">
                                                <select class="form-control form-control-sm enter_tab" data-nextTab='4' placeholder="status" name="status"/>
                                                    <option value="" class="language">Choose</option>
