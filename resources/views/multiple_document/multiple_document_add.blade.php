                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card chd">
                           <div class="card-header d-flex">
                                        <h4 class="card-header-title language big-text">ADD MULTIPLE DOCUMENTS</h4>
                                ...
                                @csrf
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9 col-lg-10">
                                                <input type="text" class="form-control enter_tab input_validasi " data-nextTab='1' name="title">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9 col-lg-10">
                                                ...
                                                <select name="type" class="form-control enter_tab input_validasi " data-nextTab='2' name="type">
                                                    <option value="" class="language">Choose</option>
                                                    <option value="pdf">PDF</option>
                                                    <option value="doc">DOC</option>
                                                    <option value="csv">CSV</option>
                                                    <option value="csv">EXCEL</option>
                                                    <option value="csv">IMAGE</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9 col-lg-10">
                                                <textarea name="description" class="form-control enter_tab input_validasi " data-nextTab='3'></textarea>
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-9 col-lg-10">
                                                <input type="file" name="files" class="input_validasi">
                                            </div>
                                        </div>
                                    </form>
...
$("#saveAdd").click(function(){
 ...
 if(validasi1 == false){
   ...
   var formDataSerialized = $("#form2").serialize();
     ...
     $.ajax({
                url:"{{url('/multiple-documents/save')}}",
                dataType: 'JSON',
                method: 'POST',
                data: formData,
                cache: false,
