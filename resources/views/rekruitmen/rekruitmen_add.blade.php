                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card chd">
                           <div class="card-header d-flex">
                                        <h4 class="card-header-title language big-text language">ADD REKRUITMEN</h4>
                                        ...
                                        <div class="toolbar ml-auto">
                                            ...
                                            <a href="{{url('/rekruitmens')}}" class="btn btn-dark btn-sm "><i class="fas fa-sign-out-alt"></i> <span class="language">Back</span></a>
                                        </div>
                                    </div>
                            <div class="card-body">
                            <!--card-body-->
