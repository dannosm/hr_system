...
$("#select_all").select_delete({buttons:'#deleteBtn',select_child:'.child',urls:"{{url('position/delete')}}",token:$("input[name='_token']").val()});
...
function load_data(){
 ...
 $('#attendace_list').DataTable({
    ...
    { data: null, render: function ( data, type, row ) {
            ...
            let id = "{{URL::to('/')}}/position/edit/"+data['id'];
