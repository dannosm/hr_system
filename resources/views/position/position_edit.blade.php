                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card chd">
                           <div class="card-header d-flex">
                                        <h4 class="card-header-title language">EDIT Position</h4>
                            ...
                            <form action="#" id="form2" class="form-horizontal" enctype="multipart/form-data">
                                    <input type="hidden" value="{{$data->id}}" name="id">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9 col-lg-10">
                                                <textarea name="description" class="form-control enter_tab language" data-nextTab='2'>{{$data->description}}</textarea>
                                            </div>
                                        </div>
